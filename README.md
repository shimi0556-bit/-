...
| [`powerpoint-course/`](powerpoint-course) | Interactive Hebrew (RTL) self-paced course on PowerPoint — beginner to advanced, 22 lessons across 3 stages with quizzes, progress tracking (localStorage), a printable keyboard-shortcut cheat sheet, a final exam, and a completion certificate. Local, single-file. | Open `index.html` directly |
| [`excel-course/`](excel-course) | Same interactive Hebrew (RTL) course format, for Excel — beginner to advanced, 21 lessons across 3 stages (formulas/references → PivotTables/Power Query → Power Pivot/DAX/VBA/dashboards) with quizzes, progress tracking, a cheat sheet, a final exam, and a completion certificate. Local, single-file. | Open `index.html` directly |
| [`gmail-course/`](gmail-course) | Same interactive Hebrew (RTL) course format, for Gmail — beginner to advanced, 21 lessons across 3 stages (compose/labels/search → filters/integrations/scheduling → 2FA/aliases/Apps Script/Workspace, with a short Outlook.com/Yahoo Mail comparison) with quizzes, progress tracking, a cheat sheet, a final exam, and a completion certificate. Local, single-file. | Open `index.html` directly |
| [`windows-desktop-course/`](windows-desktop-course) | Same interactive Hebrew (RTL) course format, for the Windows Desktop — beginner to advanced, 21 lessons across 3 stages (desktop/taskbar/Start menu basics → Snap Layouts/virtual desktops/File Explorer → accounts/security/Task Manager/PowerShell, with a short Windows 10 vs 11 comparison) with quizzes, progress tracking, a cheat sheet, a final exam, and a completion certificate. Local, single-file. | Open `index.html` directly |
| [`canva-course/`](canva-course) | Same interactive Hebrew (RTL) course format, for Canva — beginner to advanced, 22 lessons across 3 stages (editor/text/images/layers basics → Brand Kit/animations/Grids/templates → Pro/Magic Studio AI tools/video/Content Planner, with a short Adobe Express / PowerPoint comparison) with quizzes, progress tracking, a cheat sheet, a final exam, and a completion certificate. Local, single-file. | Open `index.html` directly |
