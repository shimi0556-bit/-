...
| [`obsidian-course/`](obsidian-course) | Self-contained interactive Hebrew course on Obsidian (the note-taking app) — 3 levels, 21 lessons, quizzes, printable cheat sheet, final exam, certificate. Progress saved in `localStorage`. Built with the `interactive-course-builder` skill. | Open `index.html` directly |
