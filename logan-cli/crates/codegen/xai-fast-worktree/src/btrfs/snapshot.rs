...
mod tests {
    ...
    fn test_btrfs_snapshot_metadata_round_trip() {
        let meta = BtrfsSnapshotMetadata {
            ...
            mount_target: PathBuf::from("/home/user/.logan/worktrees/repo/session/wt-abc"),
    ...
    fn test_write_and_remove_btrfs_metadata() {
        ...
        let mount_target = Path::new("/home/user/.logan/worktrees/wt-abc");
    ...
    fn test_snapshot_dest_path_separate_root_mount() {
        ...
        let dest = Path::new("/home/user/.logan/worktrees/repo/session/wt-abc");
    ...
    fn test_snapshot_dest_path_subvol_mount() {
        ...
        let dest = Path::new("/home/user/.logan/worktrees/repo/session/wt-xyz");
    ...
    fn test_snapshot_dest_path_disambiguates_same_basename_across_repos() {
        ...
        let btrfs_mount = Path::new("/mnt/btrfs");
        let subvolume_root = Path::new("/workspace/repo");
        let dest_a = Path::new("/home/user/.logan/worktrees/repo-a/session/wt-abc");
        let dest_b = Path::new("/home/user/.logan/worktrees/repo-b/session/wt-abc");
    ...
    fn test_snapshot_meta_targets_matches_only_same_dest() {
        ...
        let dest = Path::new("/home/user/.logan/worktrees/repo-a/session/wt-abc");
        ...
        let other = Path::new("/home/user/.logan/worktrees/repo-b/session/wt-abc");
