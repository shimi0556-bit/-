...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + LOGAN_HOME → private tmp + restore).
        ...
        // global LOGAN_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since LOGAN_HOME is process-global.
