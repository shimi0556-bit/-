...
Learn how to install, configure, and extend Logan, the terminal-based AI coding assistant from SpaceXAI.
...
Automate, script, and integrate Logan with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `logan -p`, output formats, CI/CD integration, and piping |
