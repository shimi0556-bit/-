...
pub(crate) const FREE_USAGE_USER_MESSAGE: &str = "You\u{2019}ve reached your free Logan usage limit for now. Get SuperGrok for much higher limits, or try again later: https://grok.com/supergrok?referrer=grok-build";
...
pub(super) fn open_credit_limit_upsell(
    ...
    let (
        ...
        CreditLimitUpsellMode::UnifiedCredits => (
            ...
            "Buy more credits",
            "Purchase credits to keep using Logan",
...
fn open_supergrok_upsell(
    ...
    let options = vec![
        ...
        QuestionOption {
            ...
            description: "Get the most out of Logan. Highest usage limits.".into(),
            preview: None,
