...
pub fn builtin_commands() -> Vec<Arc<dyn SlashCommand>> {
    vec![
        ...
        Arc::new(update_cmd::UpdateCommand),
        ...
        Arc::new(logan_modes::ThinkCommand),
        Arc::new(logan_modes::ModesCommand),
        Arc::new(logan_modes::CreativeCommand),
        Arc::new(logan_modes::SiteCommand),
        Arc::new(logan_modes::ReelCommand),
