...
//!
//! In dev mode, watches ~/.logan/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.logan/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.logan/pager.toml, watches for changes
