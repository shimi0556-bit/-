    ...
    pub fn new(grok_home: &Path, grok_com_config: GrokComConfig) -> Self {
        ...
        xai_grok_telemetry::unified_log::info(
            ...
            Some(serde_json::json!({
                ...
                "LOGAN_HOME": std::env::var("LOGAN_HOME").unwrap_or_else(|_| "(unset)".into()),
        ...
        // GROK_AUTH_PATH: custom file path (overrides default $LOGAN_HOME/auth.json).
    ...
    async fn auth_dispatch(self: &Arc<Self>) -> Result<GrokAuth, AuthError> {
        ...
        let result = match token_type {
            ...
            TokenType::LegacySession => {
                ...
                // assumption that a sibling process (`logan login` from
