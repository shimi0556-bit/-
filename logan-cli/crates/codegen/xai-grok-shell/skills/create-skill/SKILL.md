...
2. **Scope** - present the user with two options:
   - **Project** (Recommended): `<repo-root>/.logan/skills/<name>/SKILL.md` - available only in this repo, shareable with teammates
   - **User**: `~/.logan/skills/<name>/SKILL.md` - available in all projects
...
Where `<SKILL_DIR>` is:
- User scope: `~/.logan/skills/<name>`
- Project scope: `<repo-root>/.logan/skills/<name>`
