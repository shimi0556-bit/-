...
It has multiple lines."#;
    ...
    fn test_build_skill_message_exact_format() {
        let skill = SkillInfo {
            ...
            author: None,
            argument_hint: None,
            path: "/home/user/.logan/skills/commit/SKILL.md".to_string(),
            scope: SkillScope::User,
            config_source: None,
            plugin_name: None,
            plugin_version: None,
        ...
        let expected = "\
<skill name=\"commit\" description=\"Create a git commit\" path=\"/home/user/.logan/skills/commit/SKILL.md\">
# Git Commit Skill
...
<skill name=\"empty\" description=\"An empty skill\" path=\"/skills/empty/SKILL.md\">
    ...
    fn test_build_skill_message_multiline_content() {
        let skill = SkillInfo {
            ...
            path: "/repo/.logan/skills/review/SKILL.md".to_string(),
            ..SkillInfo::default()
        };
        ...
        let expected = "\
<skill name=\"review\" description=\"Review code\" path=\"/repo/.logan/skills/review/SKILL.md\">
# Code Review
...
- No warnings
    ...
    fn test_substitutions_skill_dir() {
        ...
        apply_substitutions(
            ...
            None,
            &SubstitutionContext {
                skill_dir: Some("/home/user/.logan/skills/deploy"),
                ..Default::default()
            },
        );
        assert_eq!(
            content,
            "Config at /home/user/.logan/skills/deploy/config.json"
        );
    }
...
Review code.
    ...
    fn test_build_skill_information_single() {
        ...
        let refs = vec![SkillRef {
            name: "commit",
            path: "/home/user/.logan/skills/commit/SKILL.md",
        }];
        ...
        assert!(
            result.contains(
                "<skill name=\"commit\" path=\"/home/user/.logan/skills/commit/SKILL.md\"/>"
            )
        );
    ...
    fn test_build_skill_information_multi() {
        ...
        let refs = vec![
            SkillRef {
                name: "review",
                path: "/project/.logan/skills/review/SKILL.md",
            },
            SkillRef {
                name: "lint",
                path: "/project/.logan/skills/lint/SKILL.md",
            },
        ];
        let result = build_skill_information(&blocks, &refs);
        assert!(result.starts_with("<skill_information>\n"));
