...
//! file logger that writes to `~/.logan/logs/memory.log`.
//!
//! ## When to use
//!
...
//! tail -f ~/.logan/logs/memory.log      # watch in another terminal
//! ```
...
mod inner {
    ...
    ///
    /// Writes to `~/.logan/logs/memory.log`. Filters to `xai_memory=trace`.
