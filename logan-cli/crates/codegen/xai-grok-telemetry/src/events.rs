...
/// first prompt when Logan is launched from a non-project directory).
...
/// attributed to Logan: the user saw the gate in Logan, went and
...
pub struct SubscriptionActivated {
    ...
    /// is strongly attributable to Logan's upsell surface.
