...
**Capture, free tools:**
- **[OBS Studio](https://obsproject.com/)** — free, open-source, cross-platform. Records webcam + microphone (and screen, if the lesson also needs a raw screen-record layer) to a video file. This is the standard free choice; don't reach for a paid recorder by default.
